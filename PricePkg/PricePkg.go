...
var PricePkgMetaData = &bind.MetaData{
	ABI: "[{\"inputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"constructor\"},{\"anonymous\":false,\"inputs\":[{\"indexed\":false,\"internalType\":\"string\",\"name\":\"coin\",\"type\":\"string\"}],\"name\":\"NewTransaction\",\"type\":\"event\"},{\"inputs\":[{\"internalType\":\"string\",\"name\":\"_coin\",\"type\":\"string\"}],\"name\":\"getCoinPrice\",\"outputs\":[{\"internalType\":\"string\",\"name\":\"\",\"type\":\"string\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[],\"name\":\"getContractAddress\",\"outputs\":[{\"internalType\":\"address\",\"name\":\"\",\"type\":\"address\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[],\"name\":\"owner\",\"outputs\":[{\"internalType\":\"addresspayable\",\"name\":\"\",\"type\":\"address\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"string\",\"name\":\"_coin\",\"type\":\"string\"}],\"name\":\"requestUpdate\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"string\",\"name\":\"_coin\",\"type\":\"string\"},{\"internalType\":\"string\",\"name\":\"_price\",\"type\":\"string\"}],\"name\":\"updateCoinPrice\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"newAddress\",\"type\":\"address\"}],\"name\":\"updateOwner\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"}]",
}
...
// UpdateCoinPrice is a paid mutator transaction binding the contract method 0xf5a9e551.
//
// Solidity: function updateCoinPrice(string _coin, string _price) returns()
func (_PricePkg *PricePkgTransactor) UpdateCoinPrice(opts *bind.TransactOpts, _coin string, _price string) (*types.Transaction, error) {
	return _PricePkg.contract.Transact(opts, "updateCoinPrice", _coin, _price)
}

// UpdateCoinPrice is a paid mutator transaction binding the contract method 0xf5a9e551.
//
// Solidity: function updateCoinPrice(string _coin, string _price) returns()
func (_PricePkg *PricePkgSession) UpdateCoinPrice(_coin string, _price string) (*types.Transaction, error) {
	return _PricePkg.Contract.UpdateCoinPrice(&_PricePkg.TransactOpts, _coin, _price)
}

// UpdateCoinPrice is a paid mutator transaction binding the contract method 0xf5a9e551.
//
// Solidity: function updateCoinPrice(string _coin, string _price) returns()
func (_PricePkg *PricePkgTransactorSession) UpdateCoinPrice(_coin string, _price string) (*types.Transaction, error) {
	return _PricePkg.Contract.UpdateCoinPrice(&_PricePkg.TransactOpts, _coin, _price)
}
...
func (_PricePkg *PricePkgTransactor) UpdateOwner(opts *bind.TransactOpts, newAddress common.Address) (*types.Transaction, error) {
	return _PricePkg.contract.Transact(opts, "updateOwner", newAddress)
}

// UpdateOwner is a paid mutator transaction binding the contract method 0x880cdc31.
//
// Solidity: function updateOwner(address newAddress) returns()
func (_PricePkg *PricePkgSession) UpdateOwner(newAddress common.Address) (*types.Transaction, error) {
	return _PricePkg.Contract.UpdateOwner(&_PricePkg.TransactOpts, newAddress)
}

// UpdateOwner is a paid mutator transaction binding the contract method 0x880cdc31.
//
// Solidity: function updateOwner(address newAddress) returns()
func (_PricePkg *PricePkgTransactorSession) UpdateOwner(newAddress common.Address) (*types.Transaction, error) {
	return _PricePkg.Contract.UpdateOwner(&_PricePkg.TransactOpts, newAddress)
}
